...
**Hard rule for Agents:** before reporting any task as done, after any `Edit`, `Write`, or `NotebookEdit` to a file Prettier handles (`.ts`, `.tsx`, `.mjs`, `.js`, `.json`, `.css`, `.md`, `.yml`, `.html`), run:
