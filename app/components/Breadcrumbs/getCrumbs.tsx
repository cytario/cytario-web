...
export interface CrumbsOptions {
  /** Display name for the atomic connection crumb (bucket + prefix as one unit) */
  dataConnectionName?: string;
  /** Full URL path to the connection root */
...
export const getCrumbs = (
  ...
  // When a connection with prefix is provided, render it as a single atomic crumb
  if (dataConnectionName && dataConnectionPath) {
    ...
    // Build crumbs for the remaining path segments (relative to connection root)
