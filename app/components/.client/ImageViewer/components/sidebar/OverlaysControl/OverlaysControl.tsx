...
import { OverlaysControlItem } from "./OverlaysControl.Item";
...
/**
 * OverlaysControl component manages the display and interaction of overlays in the image viewer.
  ...
  return (
    ...
    >
      {entries.map(([resourceId, overlayState]) => (
        <OverlaysControlItem key={resourceId} resourceId={resourceId} overlayState={overlayState} />
      ))}
