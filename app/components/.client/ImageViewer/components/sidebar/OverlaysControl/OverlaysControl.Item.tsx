...
import { ColorPicker, rgb } from "../ChannelsControl/ColorPicker/ColorPicker";
...
interface OverlaysControlItemProps {
  resourceId: string;
  overlayState: OverlayState;
}

export const OverlaysControlItem = ({ resourceId, overlayState }: OverlaysControlItemProps) => {
