...
import { ChannelsControlBrightfieldItem } from "./ChannelsControlBrightfieldItem";
import { ChannelsControlItem } from "./ChannelsControlItem";
import { select } from "../../../state/store/selectors";
import { BRIGHTFIELD_GROUP_ID, ChannelsStateColumns } from "../../../state/store/types";
import { useViewerStore } from "../../../state/store/ViewerStoreContext";
const MAX_VISIBLE_CHANNELS = 6;

export function ChannelsControlItemList() {
  ...
  return (
    ...
    >
      ...
      {showBrightfield && (
        <ChannelsControlBrightfieldItem
